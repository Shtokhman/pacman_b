...
function InitGhosts()
{
    ...
    ghosts.push( new Ghost( 'ghost1', 'red', 11, 15, true ) );    
    ghosts.push( new Ghost( 'ghost2', 'orange', 13, 15, true ) );   
    ghosts.push( new Ghost( 'ghost3', 'blue', 15, 15, true ) );     
    ghosts.push( new Ghost( 'ghost4', 'pink', 12, 11, false ) );    
    
    
    ghosts[0].SetWaitToGetOutCave( true );  
    ghosts[0].SetHitsBeforeGetOut( 10 );
    
    ghosts[1].SetWaitToGetOutCave( false ); 
    
    ghosts[2].SetWaitToGetOutCave( true );  
    ghosts[2].SetHitsBeforeGetOut( 20 );
    
    ghosts[3].SetWaitToGetOutCave( false ); 
}
...
Ghost.prototype.Initialize =
    function ( ghostName, color, x, y, isInTheCave )
    {
        ...
        this.xScreen = (x-1)*16 + 16; 
        this.yScreen = (y-1)*16 + 72; 
